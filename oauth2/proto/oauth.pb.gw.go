...
/*
Package oauthpb is a reverse proxy.
...
func request_OAuthService_GetCodeState_0(ctx context.Context, marshaler runtime.Marshaler, client OAuthServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterOAuthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OAuthServiceClient) error {
	...
	mux.Handle("POST", pattern_OAuthService_GetCodeState_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_OAuthService_GetCodeState_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_OAuthService_GetCodeState_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	forward_OAuthService_GetCodeState_0 = runtime.ForwardResponseMessage
)
