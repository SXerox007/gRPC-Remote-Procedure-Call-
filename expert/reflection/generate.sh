...
protoc expert/reflection/proto/chat.proto --go_out=plugins=grpc:.

// #server-run
go run expert/reflection/server/server-app.go
or 
make server

// #client-run
go run expert/reflection/client/client-app.go
or 
make client
...
//#reflection  (CLI interface )
//# CLI talk to our server or client
